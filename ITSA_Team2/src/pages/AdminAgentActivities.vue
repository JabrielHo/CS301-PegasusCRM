<template>
  <div class="admin-dashboard">
    ...
    <div class="dashboard-header">
      ...
      <p class="dashboard-subtitle">View and manage agent transaction activities</p>
    </div>
                  ...
                  <div class="transaction-details">
                    ...
                    <div class="details-grid">
                      ...
                      <div class="detail-item">
                        ...
                        <span>{{ transaction.client_id || 'N/A' }}</span>
                      </div>
                      <div class="detail-item">
    ...
    refreshActivities() {
      ...
      setTimeout(() => {
        ...
        const newTransaction = {
          ...
          date: '05/04/2025',
          agent_id: 'AG00' + Math.floor(1 + Math.random() * 5),
          client_id: 'CL' + Math.floor(100 + Math.random() * 900),
          description: 'New transaction activity'
        };
      ...
      setTimeout(() => {
        ...
        this.filteredTransactions = this.transactions.filter(transaction => {
          return (
            ...
            (transaction.agent_id && transaction.agent_id.toLowerCase().includes(query)) ||
            (transaction.client_id && transaction.client_id.toLowerCase().includes(query))
          );
        });
